...
private:
  ...
  std::unordered_set<std::string> imports = {
      "::<builtins>", "::math", "::state", "::df",
      "::limits",     "::tex",  "::debug", "::anno"};

  const std::unordered_set<std::string> stateless_return_types = {
      "material",
      "material_surface",
      "material_volume",
      "material_geometry",
  ...
  get_shorthand_operator(IExpression_binary::Operator op);
